	...
	<div class="text-center mt-5">
		<form action="studentInsert" method="post"
			...
			<input type="number" class="form-control"
				placeholder="Student Id" name="id" required autofocus> 
			
			<input type="text" class="form-control"
				placeholder="Student Name" name="name" required autofocus>
				
			<input type="text" class="form-control"
				placeholder="Student surname" name="surname" required autofocus>
